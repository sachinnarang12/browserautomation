...
try:
    ...
    result = nova.act("Login with {{credential:utility_portal:username}} and {{credential:utility_portal:password}}, select Active Home 103892 0, go to Usage, click Export")
